...
Lumholts metode består af en skal med en mindre hals, som sættes om brystet. Ved at indesende en lyd gennem halsen og opfange den reflekterede lyd, kan der bestemmes et volumen for brystet.
...
\item $W$: statisk volumen af objekt [$m^3$],\\
\end{description}
