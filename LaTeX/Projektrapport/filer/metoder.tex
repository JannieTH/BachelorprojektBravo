...
I dette afsnit gives der eksempler på, hvordan projektet er gået fra at være kravorienteret til løsningsorienteret.   Der er blandt andet brugt Block Definition Diagram (BDD) og Internal Definition Diagram (IBD). Diagrammerne benyttes til at beskrive systemet på en overskuelig måde ved opdeling i delsystemer, og beskriver på den måde funktioner og sammenhænge. Det er ud fra disse diagrammer, at systemet er udviklet. 
Der er i denne fase ikke udviklet et sekvensdiagram på baggrund af UC1, da softwareudviklingen er afhængig af udviklingen af prototypen. Softwareudviklingen er derfor udarbejdet i takt med testprocessen og de opståede behov.
