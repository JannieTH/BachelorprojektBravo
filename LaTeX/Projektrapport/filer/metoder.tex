...
\begin{figure}
\centering
\includegraphics[width=11in]{agilstagegate.pdf}
\caption{Den anvendte Stage-Gate model}
...
\subsection{Den tredje udviklingsfase: udvikling og test}Den tredje udviklingsfase er en iterativ proces bestående af design, udvikling, test og opdagelser.
I dette afsnit gives der eksempler på, hvordan projektet er gået fra at være kravorienteret til løsningsorienteret.   Der er blandt andet brugt Block Definition Diagram (BDD), Internal Definition Diagram (IBD) og sekvensdiagram. Diagrammerne benyttes til at beskrive systemet på en overskuelig måde ved opdeling i delsystemer, og beskriver på den måde funktioner og sammenhænge. Det er ud fra disse diagrammer, at systemet er udviklet.   

\subsubsection{BDD og IBD over hardware}
 BDD og IBD over hardwaren, er anvendt til at sikre, at hvert enkelte hardwarekomponent kan kommunikere med hinanden. Yderligere er det med til at definere specifikationerne, for eksempelvis at indskærpe antallet af strømforsyninger.
...
Det anvendte IBD, som fremgår af figur \ref{fig:idb}, giver en white box repræsentation af systemet. IBD'et beskriver mere præcist, hvordan de forskellige komponenter interagerer med hinanden. 
...
I designfasen er der udarbejdet specifikationer samt overvejelser for de enkelte hardwarekomponenter. Disse fremgår af Projektdokumentationen. 

\subsubsection{Sekvensdiagram}
I designdokumentet er der yderligere lavet et simpelt sekvensdiagram, hvilet giver overblik over de sekventielle dele af systemet til brugen af systemet.  Sekvensdiagrammernehar været brugt til at klargøre, hvordan softwaren skal implementeres og ihvilken rækkefølge funktionerne skal eksekveres. Derudover har det været med til at danneet overblik over delene, der skal implementeres i projektet, samt dele arbejdsopgaverne opi mindre opgaver.

Da der efter denne fase var dannet et overblik over, hvilke opgaver der var nødvendige i implementeringen, blev der udarbejdet en ny og revurderet tidsplan for projektet. 
