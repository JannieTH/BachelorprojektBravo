...
Dette kapitel beskriver vejen til CE-mærket for brystvolumenmåleren. CE-mærkningen starter ved at definiere produktet som medicinsk udstyr og derefter at klassificere produktet ud fra \textit{the European Commission's official guidance for Medical Devices - MEDDEV 2.4/1 Rev.9}. Ud fra klassificationen tydeliggøres det i MEDDEV, hvilke bilag som skal opfyldes for at opnå CE-mærkning.
...
Ydermere har produktet en målefunktion og derved skærpes kravende til CE-godkendelsen. Klassificeringen bliver derved en klasse Im.

\subsection{Vejen til CE-mærkning}

Der er flere mulige veje for brystvolumenmåleren at opnå CE-mærkningen

\begin{figure}
\centering
\includegraphics[width=5in]{Klassificering}
\caption{Klassificeringen af det medicinske udstyr har indflydelse på hvilke bilag som skal opfyldes for at opnå CE-mærkningen.}
\label{fig:Klas}
\end{figure}
