...
\subsubsection{Opstilling og opsætning}
		\texttt{optagefrekvenssignal0.5.vi} er åbnet. Blokdiagrammet er vist i figur \ref{fig:vio5}. I blokdiagrammet i \texttt{optagefrekvenssignal0.5.vi} åbnes DAQ assistant modulet og i \textit{Samples to read} indtastes 800 og i \textit{Rate(Hz)} indtastes 8000. Dette vises i figur \ref{fig:daq}.   
...
\subsection{E16-VIHRF\underline{O}}
\subsubsection{Testhypotese}
		...
		\subsubsection{Opstilling og opsætning}
		\texttt HRVF.vi} er åbnet. Blokdiagrammet for VI´et ses i figur \ref{fig:HHRF} 
...
\textit{Hardware:}\\
		...
		\daqsoft\\
\subsubsection{Opstilling og opsætning}
\texttt{optagefrekvenssignal0.7.vi} er åbnet. Blokdiagrammet er vist i figur \ref{fig:vio5}. I blokdiagrammet i \texttt{optagefrekvenssignal0.7.vi} åbnes DAQ assistant modulet og i \textit{Samples to read} indtastes 800 og i \textit{Rate(Hz)} indtastes 8000. Dette vises i figur \ref{fig:daq}.   
