...
\section{Enhedstest}
	...
	\textit{Ved samtlige test med lydgenererende funktion er der anvendt maksimalt lydtryk på den lydgivende enhed.}
	
	
	Af tabel \ref{table:enhedstests} fremgår en oversigt over de udførte enhedstests. \\
	
	 
	\begin{table}H]
				\centering
				\caption{Tabeloversigt over udførte enhedstests} 
				\label{table:enhedstests}
				\begin{tabular}{lll}
					...
					\multicolumn{1}{l|}{LabVIEW VI}&VI02G: genererfrekvenssignal02\\
