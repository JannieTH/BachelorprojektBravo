...
\section{Enhedstest}
	...
	\subsection{Minijack PC Mikrofon}
		...
		Mikrofonen er sat i PC'ens minijack-stik. Testopstillingen er vist i figur \ref{fig:etmik}.\\ 
			...
			www.onlinegenerator.com er åben i en browser på PC´en. 
...
\subsection{\elektretto 5V}
		...
		\subsubsection{Diskussion} 
		Strømforsyningen på 5V gjorde i afvigelserne i resultaterne mindre. Kan det være frekvensbåndet i PC´ens højtalere som ikke er bredt nok til at afspiller det ønskede frekvensbånd. 
		\subsubsection{Konklusion}
	Ved et signal med en frekvens på hhv. 20 Hz, 50 Hz, 100 Hz, og 10 kHz er resultaterne ikke tilnærmelsesvis de udsendte frekvenser. 
...
\subsection{\usbhøj}
		...
		\subsubsection{Udførsel}
			\begin{enumerate}
				\item I VI'et \texttt{optagefrekvenssignal0.4.vi}, trykkes på \textit{Run}.  
				\item Der generes et signal med følgende frekvens: 20 Hz, 50 Hz, 100 Hz, 1 kHz og 10 KHz. 
				\item På frontpanelet i VI'et afventes frekvensudsving på en graf.  
		...
		\subsubsection{Resultater}
		Resultaterne fremgår af tabel \ref{elektotabet} og \ref{elektotabto}. 
		
%		Tabel over resultater ved strømforsyning på 2.5 V. 
%		\begin{table}[]
%				\centering
%				\caption{Tabel over resultater ved strømforsyning på 2.5 V }}
%				\label{elektotabet}
%				\begin{tabular}{lll}
%					\multicolumn{1}{l|}{\textbf{Udsendt frekvens {[}Hz{]}}} & 	
%					\multicolumn{1}{l|}{\textbf{1. resultat}} & \textbf{2. resultat} \\ \hline
...
%			\end{table}
%%		
%		Tabel over resultater ved strømforsyning på 5 V. 
%				\begin{table}[]
%				\centering
%				\caption{Tabel over resultater ved strømforsyning på 5 V}
%				\label{elektotabto}
%				\begin{tabular}{lll}
%					\multicolumn{1}{l|}{\textbf{Udsendt frekvens {[}Hz{]}}} & 	
%					\multicolumn{1}{l|}{\textbf{1. resultat}} & \textbf{2. resultat} \\ \hline
	...
	\subsection{Bordtest nr. 2} %% Skal måske omdøbes?!
		...
		\subsubsection{Udførsel}
			...
			\subsubsection{Aktion}
			 ...
			 Dette er en citationstest \cite{aau:formalia}
