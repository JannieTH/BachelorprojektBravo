...
\subsection{\usbhøj}
		...
		Testopstillingen er vist i figur \ref{fig:usbhojop}.\\
...
\subsubsection{Testformål}
		...
		\subsubsection{Opstilling og opsætning}
		\texttt{optagefrekvenssignal0.5.vi} er åbnet og onlinetonegeneratoren er åbnet i browseren på PC´en. DAQ assistant modulet åbnes i blokdiagrammet og i \textit{Samples to read} indtastes 800 og i \textit{Rate(Hz} indtastes 8000. Dette vises i figur \ref{fig:daq}. I blokdiagrammet for \texttt{optagefrekvenssignal0.5.vi sætte antal loops til 1. 
		 Onlinetonegeneratoren åbnes DMTF generatoren. Blokdiagrammet for {optagefrekvenssignal0.5.vi} er vist i figur \ref{fig:vio5}
...
\begin{figure}
		...
		\begin{figure}
			\centering
			\includegraphics[width=3in]{optagefrekvenssignasl05}
		...
		\subsubsection{Udførsel}
			...
			\item  VI´et åbnes og på frontpanelet indstilles optagelsestiden til 4 sekunder.
			\item 
			\end{enumerate}
