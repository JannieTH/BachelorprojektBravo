...
\begin{table}[htb]
	...
	\subsection{I01-H1/M1/VI02G/VI01\underline{O}} %% Skal måske omdøbes?!
	\label{bordtest1}
		\subsubsection{Testhypotese}
		...
		På PC'en er VI'et \texttt{genererfrekvenssignal02.vi} åbnet i LabVIEW.     		Blokdiagrammet er vist i figur \ref{fig:bdgenerer}.\\ 
...
\begin{figure}[htb]
		...
		Mikrofonen er sat i PC'ens minijack-stik. På PC'en er VI'et \texttt{optagefrekvenssignal0.1.vi} åbnet i LabVIEW. Blokdiagrammet er vist i figur \ref{fig:bdoptage}.\\ 
