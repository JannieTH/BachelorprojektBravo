...
\textbf{Acceptkriterie}        & Der anvendes udelukkende visuelt symbolik \\ \hline
\textbf{Testmetode}            & Usabilitytest på min. 15 plastikkirurger med forskellig national baggrund \\ \hline
\textbf{Forventet resultat}		& Usabilitytest på min. 15 plastikkirurger med national baggrund viser, at målgruppen forstår anvendelsen af UI\\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Acceptkriterie}        & \begin{tabular}[l]{@{}l@{}} Volumenangivelse findes\\ ikke som decimaltal på UI \end{tabular} \\ \hline
...
\textbf{Forventet resultat}	& UC1.5-6 følges, og der observeres ingen decimaltal i anvendelsen af UI \\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Forventet resultat}	& Der genereres 1000 målinger uden fejl\\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Forventet resultat}	& Tidtagningen af fejlløsningen er mindre end 2 minutter \\ \hline 
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Forventet resultat}           & Tidtagning af foretaget måling viser mindre end 10 sekunder  \\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Acceptkriterie}        & Lydniveau ved måling skal være mindre end 75 dB målt med standiseret målemetode \\ \hline
\textbf{Testmetode}            & \begin{tabular}[l]{@{}l@{}} UC1 følges og lydniveau registreres med lydmåler \end{tabular}  \\ \hline
\textbf{Forventet resultat}           & Lydniveaumåling med standardiseret målemetode viser mindre end 75 dB ved brystvolumenmåling \\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Forventet resultat}	& Produktet rengøres med sprit 100 gange og foretager derefter problemfrit en måling \\ \hline 
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Forventet resultat}	& UI rengøres med sprit 100 gange og foretager derefter problemfrit en måling \\ \hline 
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Acceptkriterie}        & Funktioner skal være af standardiseret design \\ \hline
...
\textbf{Forventet resultat}	& Min. 20 plastikkirurger anvender BVM uden brug af brugermanual \\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\vspace{2mm}
DK1 kan også anses for at være et usabilitykrav og kan testes iht. ANSI/AAMI HE75:20097/(R)2013

\begin{tabularx}{1\textwidth}{|l|X|}
\hline
\textbf{Krav nr.}              & DK2  \\ \hline
\textbf{Acceptkriterie}        & Skal kunne anvendes på 90\% af tilfældigt udvalgte kvinder \\ \hline
...
\textbf{Forventet resultat} & BVM kan anvendes på min. 90 af de 100 kvinder\\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Acceptkriterie}        & Resonatoråbning må forvolde skade på huden\\ \hline
\textbf{Testmetode}            & \begin{tabular}[l]{@{}l@{}} Ergoterapeut godkender udformning \end{tabular}  \\ \hline
\textbf{Forventet resultat} & Ergoterapeut undersøger resonatoråbningen og konkluderer at den ikke kan forvolde skade på huden \\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Forventet resultat} & Ergoterapeut undersøger arbejdsstillingen og konkluderer at den ikke kan forvolde arbejdsskader\\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Forventet resultat} & Der findes ingen kabler på BVM\\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Forventet resultat} & Bemyndiget organ underskriver CE-certificering for de metrologiske apsekter på baggrund af overensstemmende dokumentation \\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
