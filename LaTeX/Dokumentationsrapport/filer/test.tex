...
\textbf{Testmetode}            & \begin{tabular}[l]{@{}l@{}} En person skal, uden kendskab til brugermanual,\\ intuitivt anvende BVM \end{tabular}  \\ \hline
\textbf{Observation}           &  \\ \hline
\textbf{Godkendt {[}Ja/Nej{]}} &  \\ \hline
\textbf{Init./Dato}            &  \\ \hline
\end{tabularx}
...
\textbf{Acceptkriterie}        & Resonatoråbning skal være anatomisk udformet \\ \hline
